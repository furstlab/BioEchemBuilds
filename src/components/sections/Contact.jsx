        ...
        <div className="px-4 w-full min-w-[300px] md:w-[600px] sm:w-2/3 p-6">
          ...
          <div className="flex flex-row gap-10 items-start mb-10">
            ...
            <ol className="list-decimal pl-8 space-y-5 text-lg flex-1">
              <li className="font-mono text-xl font-bold text-white">
                Clone the BioEchem<span className="text-blue-500">⚡Builds</span> gh_pages_webapp repository.
              </li>
              ...
              <li className="font-semibold text-sm text-cyan-300">
                Detailed instructions are available at BioEchem<span className="text-blue-500">⚡Builds</span> GitHub repo.
              </li>
            </ol>
          ...
          <div className="mt-10 text-center">
            ...
            <div className="flex justify-center gap-8 pt-2">
              ...
              <a href="https://bsky.app/profile/furstlab.bsky.social" target="_blank" rel="noopener noreferrer">
                <img src="https://raw.githubusercontent.com/swath1pen/bioreactor/main/bluesky_logo.png" alt="Bluesky" className="w-12 h-10 hover:scale-110 transition" />
              </a>
              {/* Lab */}
              <a href="https://furstlab.mit.edu/" target="_blank" rel="noopener noreferrer">
                <img src="https://raw.githubusercontent.com/swath1pen/bioreactor/main/logo.png" alt="Lab Website" className="w-13 h-13 hover:scale-110 transition" />
              </a>
              {/* Gmail/Email */}
              ...
              <a href="https://github.com/furstlab/BioEchemBuilds" target="_blank" rel="noopener noreferrer">
                <img src="https://raw.githubusercontent.com/swath1pen/bioreactor/main/github-mark-white.png" alt="GitHub" className="w-10 h-10 hover:scale-110 transition" />
              </a>
            </div>
          </div>
        </div>
